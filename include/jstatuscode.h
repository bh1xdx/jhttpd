 ...
 */
 ...
 // FROM: https://raw.githubusercontent.com/j-ulrich/http-status-codes-cpp/master/HttpStatusCodes_C%2B%2B11.h
...
namespace HttpStatus
{
     ...
     */
    inline std::string reason(int code)
    {
        switch (code)
        {
    ...
    inline std::string reason(Code code)
    {
